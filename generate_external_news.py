...
文体・トーンの重要なルール（社内で共有するような親しみやすく、カジュアルな文体で）：
## 口語表現や短縮形
...
"""
            ...
            response = self.openai_client.chat.completions.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "あなたは企業のSNS担当者です。社内のSlackメッセージから、社外に共有するのに適切な話題を見つけ、Twitter/X投稿用の親しみやすく人間味のある日本語文章を作成することが得意です。AIっぽさを感じさせない自然で会話的なトーンを心がけてください。口語表現、比喩、読者への語りかけを積極的に使い、堅苦しさを避けてください。必ず日本語で投稿文を生成してください。"},
